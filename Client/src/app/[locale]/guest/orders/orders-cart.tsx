...
//     try {
//       // Tạm đổi role để tránh lỗi phân quyền nếu có
//       store.setRole("Owner");
...
//           )}`,
//         });
//         // Có thể refetch data hoặc update UI theo data.newStatus
//       });
...
//     } catch (error) {
//       store.setRole("Guest");
//       console.log("Lỗi — đã đổi lại role thành:", store.role);
...
//           <button className="bg-blue-500 text-white text-xl font-semibold px-6 py-1 rounded-lg shadow hover:bg-blue-600 transition duration-300">
//             Thanh toán
//           </button>
//         </div>
//       </div>
...
export default function OrdersCart() {
  ...
  // Xử lý thanh toán online, ví dụ gọi API tạo link thanh toán
  ...
  //       "http://localhost:4000/payments/create-payment-link",
  //       {
  //         method: "POST",
  //         headers: {
  ...
  //           orderIds,
  //           description: "Thanh toán đơn hàng chưa thanh toán",
  //         }),
  //       }
  //     );

  //     if (!response.ok) throw new Error("Lỗi khi tạo link thanh toán");
